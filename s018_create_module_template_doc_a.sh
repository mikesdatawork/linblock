#!/bin/bash
# s018_create_module_template_doc_a.sh
# Creates docs/design/module_template.md
# Fixed version - proper heredoc escaping

PROJECT_ROOT="/home/user/projects/linblock"

cat > "$PROJECT_ROOT/docs/design/module_template.md" << 'ENDOFFILE'
...
```markdown
# Abstraction Layer: [ModuleName]Interface
...
[Brief description of what this abstraction layer provides]
...
Public abstraction layer for [module_name] functionality.
"""
...
```python
"""
Mock implementation of [module_name] abstraction layer.
...
```python
"""
Abstraction layer tests for [module_name].
...
The abstraction layer (interface) is the only point of contact between modules. Internal implementations stay hidden.
ENDOFFILE
