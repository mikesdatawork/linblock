#!/bin/bash
# s006_create_agent_02.sh
# Creates agent_02_android_platform_architect.md

PROJECT_ROOT="/home/user/projects/linblock"

cat > "$PROJECT_ROOT/agents/configs/agent_02_android_platform_architect.md" << 'EOF'
...
echo "Created: $PROJECT_ROOT/agents/configs/agent_02_android_platform_architect.md"
