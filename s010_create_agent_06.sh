#!/bin/bash
# s010_create_agent_06.sh
# Creates agent_06_gtk_python_developer.md

PROJECT_ROOT="/home/user/projects/linblock"

cat > "$PROJECT_ROOT/agents/configs/agent_06_gtk_python_developer.md" << 'EOF'
...
echo "Created: $PROJECT_ROOT/agents/configs/agent_06_gtk_python_developer.md"
