#!/bin/bash
# s020_create_build_process_doc.sh
# Creates docs/design/build_process.md

PROJECT_ROOT="/home/user/projects/linblock"

cat > "$PROJECT_ROOT/docs/design/build_process.md" << 'EOF'
...
echo "Created: $PROJECT_ROOT/docs/design/build_process.md"
