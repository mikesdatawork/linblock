#!/bin/bash
# s008_create_agent_04.sh
# Creates agent_04_linux_systems_engineer.md

PROJECT_ROOT="/home/user/projects/linblock"

cat > "$PROJECT_ROOT/agents/configs/agent_04_linux_systems_engineer.md" << 'EOF'
...
echo "Created: $PROJECT_ROOT/agents/configs/agent_04_linux_systems_engineer.md"
