#!/bin/bash
# s014_create_agent_10.sh
# Creates agent_10_devops_engineer.md

PROJECT_ROOT="/home/user/projects/linblock"

cat > "$PROJECT_ROOT/agents/configs/agent_10_devops_engineer.md" << 'EOF'
...
echo "Created: $PROJECT_ROOT/agents/configs/agent_10_devops_engineer.md"
